...
impl SettingsWindow {
    pub(in crate::ui::settings) fn models(&self, cx: &mut Context<Self>) -> Div {
    ...
    pub(in crate::ui::settings) fn model_row(
        &self,
    ...
    pub(in crate::ui::settings) fn cloud_row(
        &self,
        provider: Provider,
        connected: bool,
        selected: bool,
    ...
    pub(in crate::ui::settings) fn open_cloud(
        &mut self,
        provider: Provider,
        window: &mut Window,
        cx: &mut Context<Self>,
    ...
    pub(in crate::ui::settings) fn save_cloud(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::settings) fn remove_cloud(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::settings) fn close_modal(
        &mut self,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) {
    ...
    pub(in crate::ui::settings) fn cloud_modal(&self, cx: &mut Context<Self>) -> Div {
        let provider = self
            .cloud_config
